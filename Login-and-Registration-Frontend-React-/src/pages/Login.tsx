      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl p-8">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-4 w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 flex items-center justify-center"
          >
