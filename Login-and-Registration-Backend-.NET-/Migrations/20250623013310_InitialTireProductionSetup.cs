...
{
    /// <inheritdoc />
    public partial class InitialTireProductionSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedMachine = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductionJobs_Machines_MachineId",
                        column: x => x.MachineId,
                        principalTable: "Machines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductionJobs_ProductionOrders_ProductionOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionJobs_MachineId",
                table: "ProductionJobs",
                column: "MachineId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductionJobs_ProductionOrderId",
                table: "ProductionJobs",
